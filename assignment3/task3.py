...
class Deeper_model_before(nn.Module):
   ...
   def __init__(self,
       ...
       """
       super().__init__()
       num_filters = [32, 32, 64, 64, 128, 128]  # Set number of filters in conv layers
...
class Model2(nn.Module):
    ...
    def __init__(self,
        ...
        """
        super().__init__()
        num_filters = [64, 128, 256]  # Set number of filters in conv layers
        self.num_classes = num_classes
        # Define the convolutional layers
        self.feature_extractor = nn.Sequential(
            nn.Conv2d(
...
if __name__ == "__main__":
    ...
    model = Deeper_model_before(image_channels=3, num_classes=10)
    trainer1 = Trainer(
        batch_size,
        learning_rate,
        early_stop_count,
    ...
    create_double_plots(trainer1, trainer2, "task3")
